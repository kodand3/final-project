...
int main() {
    std::cout << "[child2] PID: " << GetCurrentProcessId() << "\n";
    Sleep(500);

    STARTUPINFOA si = { sizeof(si) };
    PROCESS_INFORMATION pi;
    if (CreateProcessA(NULL, (LPSTR)"C:\\Projects\\child4\\x64\\Debug\\child4.exe", NULL, NULL, FALSE, 0, NULL, NULL, &si, &pi)) {
        std::cout << "[child2] Launched child4.exe [PID: " << pi.dwProcessId << "]\n";
        Sleep(500);
