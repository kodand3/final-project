...
int main() {
    std::cout << "[child1] PID: " << GetCurrentProcessId() << "\n";
    Sleep(500);

    STARTUPINFOA si = { sizeof(si) };
    PROCESS_INFORMATION pi;
    if (CreateProcessA(NULL, (LPSTR)"C:\\Projects\\child3\\x64\\Debug\\child3.exe", NULL, NULL, FALSE, 0, NULL, NULL, &si, &pi)) {
        std::cout << "[child1] Launched child3.exe [PID: " << pi.dwProcessId << "]\n";
        Sleep(500);
